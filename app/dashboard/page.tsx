    ...
    <>
      ...
      <style>{`
        ...
        .dashboard-title {
          ...
          color: var(--color-brand-white); margin: 0 0 0.3rem;
        }
        .dashboard-sub { font-family: var(--font-body); font-size: 0.875rem; color: var(--color-brand-muted); margin: 0; }
        .logout-btn {
        ...
        .progress-grid { display: flex; flex-direction: column; gap: 0.75rem; }
        .progress-card {
          display: flex; align-items: center; gap: 1rem;
          background: var(--color-brand-dark); border: 1px solid var(--color-brand-border);
          border-radius: 4px; padding: 0.75rem; text-decoration: none; transition: border-color 0.2s;
        }
        .progress-card:hover { border-color: var(--color-brand-muted); }
        .progress-poster { width: 60px; height: 90px; object-fit: cover; border-radius: 2px; flex-shrink: 0; }
        .progress-poster-placeholder {
          width: 60px; height: 90px; background: var(--color-brand-surface);
          border-radius: 2px; display: flex; align-items: center; justify-content: center;
          font-family: var(--font-display); font-size: 1.5rem;
          color: var(--color-brand-border); flex-shrink: 0;
        }
        .progress-info { flex: 1; min-width: 0; }
        .progress-title {
          font-family: var(--font-display); font-size: 0.95rem; font-weight: 600;
          color: var(--color-brand-white); margin: 0 0 0.35rem;
        ...
        .progress-bar-wrap { height: 3px; background: var(--color-brand-border); border-radius: 2px; overflow: hidden; }
        .progress-bar-fill { height: 100%; background: var(--color-brand-accent); border-radius: 2px; }
        .progress-play { color: var(--color-brand-muted); flex-shrink: 0; opacity: 0; transition: opacity 0.2s; }
        .progress-card:hover .progress-play { opacity: 1; }
        .dashboard-empty { text-align: center; padding: 4rem 0; color: var(--color-brand-muted); font-family: var(--font-body); }
        .browse-btn {
          display: inline-block; margin-top: 1rem;
          font-family: var(--font-body); font-size: 0.875rem; font-weight: 600;
          color: var(--color-brand-black); background: var(--color-brand-accent);
          padding: 0.65rem 1.5rem; border-radius: 2px; text-decoration: none;
        }
      `}</style>
    </>
  );
